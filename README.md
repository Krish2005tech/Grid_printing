The main aim of this is to allow for easy access to a 2d grid with x,y coordinates. It can be used to create a chess board, Maze or just anything you could think of with a grid. 
